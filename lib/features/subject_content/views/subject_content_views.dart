  ...
  Future<void> openYouTubeLink(String link) async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('الرابط غير صالح')));
    }
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          unselectedLabelColor: Colors.grey.shade600, // لون التبويب غير المحدد
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CustomText(
                      text:
                          'متوسط التقييم: ⭐ ${reviewProvider.getCourseAverageRating(course!.id).toStringAsFixed(1)}',
                      size: 15,
