                      ...
                      child: Row(
                        ...
                        children: [
                            ...
                            children: [
                              Container(
                                ...
                                child: CircleAvatar(
                                  ...
                                  foregroundImage: AssetImage('${cours.image}'),
                                ),
                              ),
                            ],
                          ),
                          ...
                          Column(
                            ...
                            children: [
                              // العنوان
                              RowTwoParts(titel: 'المادة :', text: cours.title),
                              ...
                              onSelected: (String value) {
                                if (value == 'edit') {
                                  ...
                                  TextEditingController titleController =
                                      TextEditingController(text: cours.title);
                                  TextEditingController descController =
                                      TextEditingController(
                                        text: cours.description,
                                      );
                                  TextEditingController imageController =
                                      TextEditingController(text: cours.image);
